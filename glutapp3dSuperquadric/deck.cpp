...
void Deck::createBox(double x0, double y0, double z0, double length, double width, double height, GsArray<GsVec> &P, GsArray<GsColor> &C, GsColor color) {

//	int i;

	/*for (i = 0; i < 12; i++)
		//T.push(GsVec2(0.0, 0.0));*/
	...
	// Side 3
	P.push(GsVec(x0 - length / 2, y0 + height / 2, z0 + width / 2));
	//T.push(GsVec2(1.0, 0.0));
	P.push(GsVec(x0 - length / 2, y0 + height / 2, z0 - width / 2));
	//T.push(GsVec2(1.0, 1.0));
	P.push(GsVec(x0 + length / 2, y0 + height / 2, z0 + width / 2));
	//T.push(GsVec2(0.0, 1.0));
	P.push(GsVec(x0 + length / 2, y0 + height / 2, z0 + width / 2));
	P.push(GsVec(x0 + length / 2, y0 + height / 2, z0 - width / 2));
	P.push(GsVec(x0 - length / 2, y0 + height / 2, z0 - width / 2));
...
void Deck::build()
{
	...
	//Floor supports
	createBox(0.0, 0.0, 0.0, 0.3, 0.8, 0.015, P, C, GsColor::yellow);
	//createBox(0.0, 0.005, 0.0, 0.25, 0.8, 0.015, P, C, GsColor::darkgray);


	// Tail
	for (i = 0; i < 48; i++)
	{
		//C.push(GsColor::yellow);
	}


	P.push(GsVec(-0.15, -0.0075, -0.4));
	P.push(GsVec(-0.15, 0.0075, -0.4));
	P.push(GsVec(-0.10, 0.08, -0.55));
	P.push(GsVec(-0.10, 0.08, -0.55));
	P.push(GsVec(-0.10, 0.07, -0.55));
	P.push(GsVec(-0.15, -0.0075, -0.4));
...
void Deck::draw(const GsMat& tr, const GsMat& pr, const GsLight& l)
{
	float f[4];
