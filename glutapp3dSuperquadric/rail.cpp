...
void Rail::createBox(double x0, double y0, double z0, double length, double width, double height, GsArray<GsVec> &P, GsArray<GsColor> &C, GsColor color) {
...
void Rail::build()
{
	...
	//Floor supports
	createBox(0.0, 0.0, 0.70, 0.25, 0.10, 0.015, P, C, GsColor::red);
	createBox(0.0, 0.0, -0.70, 0.25, 0.10, 0.015, P, C, GsColor::red);

	// Beam length
	createBox(0.0, 0.25, 0.0, 0.050, 1.6, 0.025, P, C, GsColor::red);


	//Vertical supports
	createBox(0.0, 0.12, 0.70, 0.050, 0.025, 0.25, P, C, GsColor::red);
	createBox(0.0, 0.12, -0.70, 0.050, 0.025, 0.25, P, C, GsColor::red);
...
void Rail::draw(const GsMat& tr, const GsMat& pr, const GsLight& l)
{
	float f[4];
