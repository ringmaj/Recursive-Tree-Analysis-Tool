...
void SoClock::build(float t)
{
	

	double x = 0.425f + (0.65f * t);
	double height = 0.05f;



	P.push(GsVec(x, 0.6 + height, 0.0));
	P.push(GsVec(x, 0.6 - height, 0.0));


	P.push(GsVec(x, 0.1 + height, 0.0));
	P.push(GsVec(x, 0.1 - height, 0.0));



	P.push(GsVec(x, -0.4 + height, 0.0));
	P.push(GsVec(x, -0.4 - height, 0.0));



	P.push(GsVec(x, -0.9 + height, 0.0));
	P.push(GsVec(x, -0.9 - height, 0.0));
